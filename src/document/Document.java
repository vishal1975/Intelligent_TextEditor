...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		for(int i=0;i<ch.length;i++) {
			if(count!=0 && i==ch.length-1 && ch[i]=='e') {
				count =count;
			}
				
			else 	if(i>0 && (ch[i-1]=='a'|| ch[i-1]=='A'|| ch[i-1]=='e'|| ch[i-1]=='E'|| ch[i-1]=='I'|| ch[i-1]=='i'
					|| ch[i-1]=='O'|| ch[i-1]=='o'|| ch[i-1]=='U'|| ch[i-1]=='u'|| ch[i-1]=='y'|| ch[i-1]=='Y'))
				count=count;
			
				
				
			else if(ch[i]=='a'|| ch[i]=='A'|| ch[i]=='e'|| ch[i]=='E'|| ch[i]=='I'|| ch[i]=='i'
